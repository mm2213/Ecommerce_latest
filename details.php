       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/logo.jpg" alt="Theodore Logo" class="hidden-xs">
                   <img src="images/logo.jpg" alt="Theodore Logo Mobile" class="visible-xs">
                       ...
                       <div id="mainImage"><!-- #mainImage Begin -->
                           <div id="myCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Begin -->
                               ...
                               <div class="carousel-inner">
                                   ...
                                   <div class="item">
                                       <center><img class="img-responsive" src="admin_area/product_images/<?php echo $pro_img5; ?>" alt="Product 3-e"></center>
                                   </div>
                               </div>
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                    ...
                    <!--               <label class="col-md-5 control-label">Product Size</label>
                       ...
                       <div class="row" id="thumbs"><!-- row Begin -->
                           ...
                           <div class="col-xs-4"><!-- col-xs-4 Begin -->
                               <a data-target="#myCarousel" data-slide-to="4"  href="#" class="thumb"><!-- thumb Begin -->
                                   <img src="admin_area/product_images/<?php echo $pro_img5; ?>" alt="product 5" class="img-responsive">
                               </a><!-- thumb Finish -->
                           </div><!-- col-xs-4 Finish -->
